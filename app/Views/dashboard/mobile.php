...
<body>
    ...
    <div id="language-modal"
        ...
        <div
            ...
            <h2 style="color: white; font-size: 18px; font-weight: 700; margin-bottom: 25px; text-align: center;">Idioma
                / 语言</h2>
    ...
    <div class="mobile-wrapper">
        <div class="dashboard-panel-desktop">
            ...
            <div class="desktop-sidebar-menu">
                <div
                    style="display: flex; align-items: center; justify-content: center; margin-bottom: 25px; padding: 10px 0;">
                    <?php
                    ...
                    <?php else: ?>
                        <span style="font-size: 22px; font-weight: 800; color: #3b82f6; letter-spacing: 1px;">GUARDIAN
                            ADMIN</span>
                    <?php endif; ?>
                </div>
                ...
                <div
                    style="background: rgba(255,255,255,0.02); border: 1px solid rgba(255,255,255,0.05); padding: 15px; border-radius: 12px; margin-bottom: 20px;">
                    <p
                        style="font-size: 10px; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px;">
                        Meu Saldo</p>
                    <div id="desktop-balance-badge" style="font-size: 20px; font-weight: 700; color: #4ade80;">R$ 0,00
                    </div>
                </div>
                ...
                <div style="display: flex; flex-direction: column; gap: 6px; margin-bottom: 25px;">
                    <button onclick="openContractsModal()"
                        style="display: flex; align-items: center; gap: 12px; width: 100%; background: none; border: 1px solid rgba(255,255,255,0.05); color: #cbd5e1; padding: 12px 16px; border-radius: 8px; font-size: 13px; cursor: pointer; text-align: left; transition: all 0.2s;">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <span id="contracts-badge-desktop"
                            style="display: none; background: #ef4444; color: white; font-size: 9px; font-weight: 800; min-width: 16px; height: 16px; border-radius: 8px; align-items: center; justify-content: center; padding: 0 3px; line-height: 1;"></span>
                    </button>
                    ...
                    <button onclick="openNotificationsModal()"
                        ...
                        <span id="notifications-badge-desktop"
                            style="display: none; background: #ef4444; color: white; font-size: 9px; font-weight: 800; min-width: 16px; height: 16px; border-radius: 8px; align-items: center; justify-content: center; padding: 0 3px; line-height: 1;"></span>
                    </button>
                ...
                <div style="margin-bottom: 20px;">
                    <p
                        style="font-size: 10px; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 6px;">
                        Endereço de Carteira</p>
                    <div
                        style="background: rgba(15, 23, 42, 0.5); padding: 10px; border-radius: 8px; border: 1px dashed #334155; font-family: monospace; font-size: 11px; color: #818cf8; word-break: break-all; line-height: 1.4;">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <select onchange="changeLanguage(this.value)"
                        style="width: 100%; background: #0f172a; border: 1px solid #334155; color: white; padding: 8px; border-radius: 8px; outline: none; font-size: 12px; cursor: pointer;">
                ...
                <a href="<?= url_to('logout') ?>"
                    style="display: flex; align-items: center; justify-content: center; gap: 10px; width: 100%; border: 1px solid rgba(239, 68, 68, 0.2); background: rgba(239, 68, 68, 0.05); color: #f87171; padding: 12px; border-radius: 8px; font-size: 13px; text-decoration: none; font-weight: 700; cursor: pointer; text-align: center; transition: all 0.2s;">
            ...
            <div class="mobile-only-views">
                <header class="mobile-header">
                    ...
                    <div style="display: flex; gap: 14px; align-items: center;">
                        <!-- Tradutor -->
                        <div id="translator-trigger" onclick="window.openLanguageModal()"
                            ontouchstart="window.openLanguageModal()"
                ...
                <?php if ($hasInactiveWallet): ?>
                    <div
                        style="background: rgba(239, 68, 68, 0.15); border-bottom: 1px solid rgba(239, 68, 68, 0.3); color: #fca5a5; padding: 10px 20px; font-size: 12px; text-align: center; font-weight: 600; display: flex; align-items: center; justify-content: center; gap: 8px;">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round" style="color: #ef4444; flex-shrink: 0;">
                            <path
                ...
                <!-- Saldo Mobile -->
                <div
                    style="background: rgba(15, 23, 42, 0.8); backdrop-filter: blur(12px); padding: 10px 20px; border-bottom: 1px solid rgba(59, 130, 246, 0.2); display: flex; justify-content: space-between; align-items: center;">
                    <div>
                        <p
                            style="font-size: 11px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 4px;">
                            Saldo
                        </p>
                    ...
                    <div>
                        <p
                            style="font-size: 11px; color: #94a3b8; text-transform: uppercase; letter-spacing: 0.05em; margin-bottom: 4px; text-align: right;">
                            <?= $isChinese ? '现货价' : 'Cotação' ?>
                        </p>
                ...
                <div id="promotional-lots-mobile"
                    style="display: none; padding: 10px 20px; border-bottom: 1px solid rgba(239, 68, 68, 0.2); background: rgba(239, 68, 68, 0.02);">
                </div>

                <!-- Botão Comprar + Depositar Mobile -->
                <div
                    style="padding: 8px 15px; background: rgba(15, 23, 42, 0.8); border-bottom: 1px solid rgba(59, 130, 246, 0.1); display: flex; gap: 8px;">
                    <button onclick="openBuyModal(currentExchangeRate)"
        ...
        <div class="chat-panel-desktop">
            ...
            <div class="desktop-chat-header">
                ...
                <div style="display: flex; align-items: center; gap: 15px;">
                    <!-- Live Rate -->
                    <div class="live-rate-desktop"
                        style="background: rgba(59, 130, 246, 0.08); border: 1px solid rgba(59, 130, 246, 0.15); padding: 6px 12px; border-radius: 99px; display: flex; align-items: center; gap: 8px;">
                        <span class="rate-dot"
                            style="width: 8px; height: 8px; background: #3b82f6; border-radius: 50%; display: inline-block;"></span>
                        <span id="live-rate-val-desktop" style="color: #3b82f6; font-weight: 700; font-size: 13px;">R$
                            0,0000</span>
                    </div>
                    <!-- Tradutor -->
                    <div onclick="window.openLanguageModal()"
                        style="color: #3b82f6; cursor: pointer; display: flex; align-items: center;" title="Traduzir">
            ...
            <form class="mobile-input-area" id="chat-form">
                <input type="text" class="mobile-input" id="user-input"
                    placeholder="<?= lang('App.chat_placeholder') ?>" autocomplete="off">
    ...
    <div id="buy-modal"
        ...
        <div
            ...
            <div style="text-align: center; margin-bottom: 25px;">
                ...
                <?php if ($purchaseModel === 'both'): ?>
                    <div id="mode-toggle" style="display: flex; gap: 10px; justify-content: center; margin-top: 10px;">
                        <button type="button" class="mode-toggle-btn" data-mode="usdt"
                            style="flex:1; padding: 8px; border-radius: 8px; border: 1px solid #334155; background: rgba(99,102,241,0.15); color: #cbd5e1; cursor: pointer; font-size: 13px; font-weight: 600;"><?= lang('App.amount_usdt') ?></button>
                        <button type="button" class="mode-toggle-btn" data-mode="brl"
                            style="flex:1; padding: 8px; border-radius: 8px; border: 1px solid #334155; background: rgba(99,102,241,0.15); color: #cbd5e1; cursor: pointer; font-size: 13px; font-weight: 600;"><?= lang('App.amount_brl') ?></button>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div style="margin-bottom: 20px;">
                ...
                if (!empty($wallets)) {
                    foreach ($wallets as $w) {
                        if ($w['is_default'] && ($w['status'] ?? 'active') === 'active') {
                ...
                <div
                    ...
                    <?= esc($defaultWallet ?: ($isChinese ? '无活跃钱包' : 'Nenhuma carteira ativa')) ?>
                </div>
                <input type="hidden" id="wallet-selector" value="<?= esc($defaultWallet ?: '') ?>">
            </div>


            <div id="usdt-input-group"
                style="margin-bottom: 20px; <?= $initialMode === 'brl' ? 'display:none;' : '' ?>">
                ...
                <div class="delivery-selector" style="display: flex; gap: 10px; margin-bottom: 20px;">
                    ...
                    foreach ($options as $opt):
                        ...
                        if ($allowed == 'all' || $allowed == $opt):
                            ?>
                            <div class="delivery-option <?= $is_disabled ? 'disabled' : ($first ? 'active' : '') ?>"
                                data-value="<?= $opt ?>"><?= $opt ?></div>
                            <?php if ($first && !$is_disabled) {
                                $first = false;
                                $active_val = $opt;
                            } ?>
                            <?php
    ...
    <div id="buy-promo-modal"
        ...
        <div
            ...
            <div style="text-align: center; margin-bottom: 25px;">
                ...
                <div
                    style="background: rgba(244, 63, 94, 0.1); border: 1px solid rgba(244, 63, 94, 0.2); padding: 6px 12px; border-radius: 20px; display: inline-block; font-size: 11px; font-weight: 700; color: #f43f5e; text-transform: uppercase; letter-spacing: 0.05em;">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="hidden" id="promo-wallet-selector" value="<?= esc($defaultWallet ?: '') ?>">
            </div>

            <div id="promo-usdt-input-group" style="margin-bottom: 20px;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
                    <label for="promo-usdt-amount" style="color: #94a3b8; font-size: 13px; font-weight: 500;">Valor em
                        USDT (USDT)</label>
            ...
            <div id="promo-conversion-info"
                style="margin-bottom: 25px; background: rgba(15, 23, 42, 0.4); padding: 15px; border-radius: 12px; border: 1px solid #1e293b;">
                <div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
                    <span style="color: #94a3b8; font-size: 13px; font-weight: 500;">Cotação Final:</span>
                    <span id="promo-modal-rate"
                        style="color: #fca5a5; font-weight: 700; font-size: 18px; font-family: 'Outfit', sans-serif;">R$
                        0,0000</span>
                </div>
                <div id="promo-result-label"
                    ...
                    <span style="color: #94a3b8; font-size: 14px; font-weight: 700;">Total em BRL:</span>
                    <span id="promo-brl-result"
                        style="color: #f43f5e; font-weight: 800; font-size: 22px; font-family: 'Outfit', sans-serif;">R$
                        0,00</span>
                </div>
            </div>
    ...
    <div id="success-modal"
        ...
        <div class="auth-container"
            ...
            <h2 style="color: white; font-size: 24px; font-weight: 700; margin-bottom: 12px;">
                <?= lang('App.transaction_success_title') ?>
            </h2>
            ...
            <div id="success-actions">
                <button onclick="closeSuccessModal()"
                    style="width: 100%; background: rgba(255,255,255,0.05); color: #94a3b8; border: 1px solid rgba(255,255,255,0.1); padding: 15px; border-radius: 12px; cursor: pointer; font-weight: 600;">
                    <?= lang('App.understood') ?>
                </button>
            </div>
        </div>
    ...
    <div id="deposit-modal"
        style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.9); z-index: 5001; justify-content: center; align-items: center; padding: 20px; backdrop-filter: blur(10px);">
        <div
            style="max-width: 440px; width: 100%; background: #1e293b; padding: 32px; border-radius: 24px; border: 1px solid rgba(16,185,129,0.2); position: relative; max-height: 90vh; display: flex; flex-direction: column; overflow: hidden;">
            <button onclick="closeDepositModal()"
                style="position: absolute; right: 16px; top: 16px; background: none; border: none; color: #94a3b8; font-size: 24px; cursor: pointer; z-index: 10;">&times;</button>

            <div style="flex-shrink: 0; text-align: center;">
                <div
                    style="width: 52px; height: 52px; background: rgba(16,185,129,0.1); border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 auto 12px;">
            ...
            <input type="file" id="deposit-bulk-input" multiple accept="image/*,application/pdf" style="display:none"
            ...
            <div id="deposit-items-list"
                style="overflow-y: auto; flex: 1; min-height: 0; display: flex; flex-direction: column; gap: 16px; padding-right: 6px; margin-bottom: 16px;">
            </div>
    ...
    <div id="session-expired-modal"
        ...
        <div
            style="max-width: 360px; width: 100%; text-align: center; background: rgba(30, 41, 59, 0.95); border: 1px solid rgba(239, 68, 68, 0.3); padding: 40px 30px; border-radius: 24px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.6);">
            <div
                style="width: 64px; height: 64px; background: rgba(239, 68, 68, 0.1); border: 2px solid #ef4444; border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 auto 20px;">
    ...
    <div id="contracts-modal"
        ...
        <div
            ...
            <!-- Loading state -->
            <div id="debts-loading" style="text-align:center;padding:30px;color:#64748b;font-size:14px;">Carregando...
            </div>
            ...
            <div id="debts-summary" style="display:none;">
                <!-- A Pagar (BRL) -->
                <div
                    style="background:rgba(239,68,68,0.07);border:1px solid rgba(239,68,68,0.2);border-radius:16px;padding:20px;margin-bottom:12px;">
                    <p
                        style="font-size:10px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.07em;margin-bottom:6px;">
                        Total a Pagar</p>
                ...
                <!-- USDT card -->
                <div
                    style="background:rgba(99,102,241,0.07);border:1px solid rgba(99,102,241,0.2);border-radius:14px;padding:16px 18px;">
                    <p
                        style="font-size:9px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.07em;margin-bottom:5px;">
                        USDT a receber</p>
            ...
            <div id="contracts-empty" style="display:none;text-align:center;padding:40px 20px;">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="#334155" stroke-width="1.5"
                    stroke-linecap="round" stroke-linejoin="round" style="margin:0 auto 16px;display:block;">
                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" />
                    <polyline points="14 2 14 8 20 8" />
                </svg>
    ...
    <div id="statement-modal"
        ...
        <div
            ...
            <button onclick="openContractsModal()"
                ...
                <div style="display:flex; gap:12px; flex:1; min-width:0; justify-content:space-between;">
                    <div style="min-width:0; flex:1;">
                        <p
                            style="font-size:9px;color:#94a3b8;text-transform:uppercase;letter-spacing:0.06em;margin-bottom:3px;white-space:nowrap;">
                            Meu Saldo</p>
                        <p id="stmt-balance"
                            style="font-size:13px;font-weight:800;color:#4ade80;line-height:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                            R$ 0,00</p>
                    </div>
                    <div style="min-width:0; flex:1; display:none;">
                        <p
                            ...
                            A Pagar</p>
                        <p id="stmt-pos-brl"
                            style="font-size:13px;font-weight:800;color:#f87171;line-height:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                            R$ 0,00</p>
                    </div>
                    <div style="min-width:0; flex:1;">
                        <p
                            ...
                            A Receber</p>
                        <p id="stmt-pos-usdt"
                            style="font-size:13px;font-weight:800;color:#a78bfa;line-height:1;white-space:nowrap;overflow:hidden;text-overflow:ellipsis;">
                            0,00 USDT</p>
                    </div>
                </div>
            ...
            <!-- Filters -->
            <div
                style="display: flex; gap: 8px; margin-bottom: 12px; overflow-x: auto; padding-bottom: 2px; flex-shrink: 0;">
            ...
            <button onclick="toggleAdvancedFilters()"
                ...
                <svg id="stmt-filters-chevron" width="12" height="12" viewBox="0 0 24 24" fill="none"
            ...
            <div id="statement-advanced-filters"
                style="display:none; flex-direction:column; gap:10px; margin-bottom:16px; background:rgba(15,23,42,0.3); padding:12px; border-radius:16px; border:1px solid rgba(51,65,85,0.4); flex-shrink:0;">
                <!-- Dates Grid -->
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
                    <div>
                        <label
                            style="display:block; font-size:9px; color:#64748b; text-transform:uppercase; font-weight:700; margin-bottom:4px;">De</label>
                    ...
                    <div>
                        <label
                            style="display:block; font-size:9px; color:#64748b; text-transform:uppercase; font-weight:700; margin-bottom:4px;">Até</label>
                ...
                <div style="display:grid; grid-template-columns:1fr 1fr; gap:10px;">
                    <div>
                        <label
                            style="display:block; font-size:9px; color:#64748b; text-transform:uppercase; font-weight:700; margin-bottom:4px;">Tipo</label>
                    ...
                    <div>
                        <label
                            style="display:block; font-size:9px; color:#64748b; text-transform:uppercase; font-weight:700; margin-bottom:4px;">Status</label>
            ...
            <div id="statement-loader"
                style="display:none;text-align:center;padding:12px 0;color:#475569;font-size:13px;flex-shrink:0;">
                <?= lang('App.loading') ?>
            </div>
    ...
    <div id="notifications-modal"
        ...
        <div
            ...
            <div id="notifications-list"
                style="overflow-y: auto; flex: 1; min-height: 0; display: flex; flex-direction: column; gap: 12px;">
            </div>
            ...
            <div id="notifications-empty"
                style="display:none;text-align:center;padding:40px 20px;color:#64748b;font-size:14px;">
    ...
    <div id="alert-notification-modal"
        style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.8); z-index: 6000; justify-content: center; align-items: center; padding: 20px; backdrop-filter: blur(8px);">
        <div
            style="background: rgba(30, 41, 59, 0.98); width: 100%; max-width: 380px; padding: 30px; border-radius: 24px; text-align: center; border: 2px solid #3b82f6; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.6); position: relative; animation: scaleUp 0.3s cubic-bezier(0.16, 1, 0.3, 1) forwards;">
            <!-- Icon -->
            <div id="alert-notif-icon-container"
                style="width: 56px; height: 56px; background: rgba(59, 130, 246, 0.1); border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 auto 20px; color: #3b82f6;">
            ...
            <h2 id="alert-notif-title" style="color: white; font-size: 18px; font-weight: 700; margin-bottom: 12px;">
            </h2>
            <p id="alert-notif-message" style="color: #94a3b8; font-size: 14px; line-height: 1.5; margin-bottom: 25px;">
            </p>

            <button onclick="closeAlertNotifModal()"
                style="width: 100%; background: #3b82f6; color: white; border: none; padding: 12px; border-radius: 12px; font-weight: 600; font-size: 14px; cursor: pointer; transition: background 0.2s;"
    ...
    <div id="proof-modal"
        style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.9); z-index: 5001; justify-content: center; align-items: center; padding: 20px; backdrop-filter: blur(10px);">
        <div
            style="width: 100%; max-width: 400px; background: #1e293b; padding: 30px; border-radius: 24px; text-align: center; border: 1px solid rgba(59, 130, 246, 0.2);">
            <div
                style="width: 60px; height: 60px; background: rgba(59, 130, 246, 0.1); border-radius: 50%; display: flex; justify-content: center; align-items: center; margin: 0 auto 20px;">
            ...
            <label for="proof-file" id="file-label"
                style="display: block; padding: 25px; border: 2px dashed rgba(59, 130, 246, 0.3); border-radius: 16px; cursor: pointer; transition: 0.3s; margin-bottom: 20px;">
                <span id="file-name"
                    style="color: #60a5fa; font-weight: 500; font-size: 14px;"><?= $isChinese ? '点击此处选择文件' : 'Clique aqui para selecionar' ?></span>
            </label>

            <div style="margin-bottom: 20px; text-align: left;">
                <label
                    style="display: block; color: #94a3b8; font-size: 13px; margin-bottom: 8px;"><?= $isChinese ? '备注 (可选)' : 'Observações (Opcional)' ?></label>
                <textarea id="proof-text" rows="3"
                    style="width: 100%; background: #0f172a; border: 1px solid #334155; border-radius: 12px; color: white; padding: 12px; font-size: 14px; outline: none; resize: none;"
                    placeholder="<?= $isChinese ? '输入任何额外信息...' : 'Digite qualquer informação extra...' ?>"></textarea>
            </div>

            <button id="upload-btn" onclick="uploadProof()"
                style="width: 100%; display: none; background: #6366f1; border: none; padding: 15px; border-radius: 12px; color: white; font-weight: 700;">
                <?= $isChinese ? '开始上传' : 'Iniciar Upload' ?>
            </button>

            <button onclick="closeProofModal()"
                style="margin-top: 15px; background: none; border: none; color: #64748b; font-size: 13px; cursor: pointer;"><?= $isChinese ? '稍后再说' : 'Fazer isso mais tarde' ?></button>
        </div>
    </div>
    ...
    <div id="proof-preview-modal"
        ...
        <div
            ...
            <div
                style="background: rgba(15,23,42,0.4); border: 1px solid rgba(255,255,255,0.05); border-radius: 12px; padding: 10px; margin-bottom: 20px; min-height: 200px; display: flex; align-items: center; justify-content: center; overflow: hidden;">
                <img id="proof-preview-img" src="" alt="Comprovante"
                    style="max-width: 100%; max-height: 55vh; border-radius: 8px; display: none; object-fit: contain;">
            ...
            <div style="display: flex; gap: 12px;">
                <a id="proof-preview-download" href="" target="_blank" download
                    style="flex: 1; display: inline-flex; align-items: center; justify-content: center; gap: 8px; background: #6366f1; color: white; padding: 12px; border-radius: 12px; font-weight: 700; text-decoration: none; font-size: 13px; transition: background 0.2s;">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                        <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4" />
                        <polyline points="7 10 12 15 17 10" />
                ...
                <button onclick="closeProofPreviewModal()"
                    style="flex: 1; background: rgba(255,255,255,0.05); color: #cbd5e1; border: 1px solid rgba(255,255,255,0.1); padding: 12px; border-radius: 12px; font-weight: 700; font-size: 13px; cursor: pointer; transition: background 0.2s;">
                    <?= $isChinese ? '关闭' : 'Fechar' ?>
                </button>
            </div>
        </div>
    ...
    <div id="my-account-modal"
        ...
        <div
            ...
            <h1
                style="font-size: 20px; color: white; font-weight: 700; margin-bottom: 20px; text-align: left; display: flex; align-items: center; gap: 10px;">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                    stroke-linecap="round" stroke-linejoin="round" style="color: #60a5fa;">
                    <path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2" />
                    <circle cx="12" cy="7" r="4" />
                </svg>
            ...
            <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 25px;">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px; font-size: 13px;">
                    <div>
                        <span
                            style="color: #94a3b8; display: block; font-size: 11px;"><?= $isChinese ? '登录名' : 'Login' ?></span>
                        <strong style="color: white;"><?= esc($user['login']) ?></strong>
                    </div>
                    <div>
                        <span
                            style="color: #94a3b8; display: block; font-size: 11px;"><?= $isChinese ? '角色' : 'Nível de Acesso' ?></span>
                        <span
                            style="background: rgba(59, 130, 246, 0.1); color: #60a5fa; padding: 2px 8px; border-radius: 4px; font-weight: 600; font-size: 11px; display: inline-block;">
                    ...
                    <div>
                        ...
                        <strong
                            style="color: white; text-transform: uppercase;"><?= esc($user['default_contract_type'] ?? 'D+1') ?></strong>
                    </div>
                    <?php if (isset($user['daily_interest_rate']) && floatval($user['daily_interest_rate']) != 0): ?>
                        <div>
                            <span
                                style="color: #94a3b8; display: block; font-size: 11px;"><?= $isChinese ? '日利率' : 'Juros Diários' ?></span>
                            <strong
                                style="color: white;"><?= number_format($user['daily_interest_rate'] ?? 0, 2) ?>%</strong>
                        </div>
                    <?php endif; ?>
                    <div>
                        <span
                            style="color: #94a3b8; display: block; font-size: 11px;"><?= $isChinese ? '支持的交易模式' : 'Modelos de Compra' ?></span>
                        <strong
                            style="color: white; text-transform: uppercase;"><?= esc($user['purchase_model'] ?? 'USDT') ?></strong>
                    </div>
                </div>

                <div style="margin-top: 5px; display: flex; flex-direction: column; gap: 8px;">
                    <span
                        style="color: #94a3b8; display: block; font-size: 11px;"><?= $isChinese ? 'USDT (TRC-20) 钱包地址' : 'Carteira(s) USDT (TRC-20)' ?></span>
                    <?php if (!empty($wallets)): ?>
                        <?php foreach ($wallets as $w): ?>
                            <div
                                style="background: rgba(15,23,42,0.4); padding: 8px 12px; border-radius: 8px; border: 1px solid rgba(255,255,255,0.05); display: flex; justify-content: space-between; align-items: center; gap: 10px;">
                                <span
                                    style="color: #818cf8; font-family: monospace; font-size: 12px; word-break: break-all; font-weight: 500; flex: 1;">
                                    <?= esc($w['address']) ?>
                                    <?php if ($w['is_default']): ?>
                                        <small
                                            style="color: #6366f1; font-weight: 700; font-size: 9px; margin-left: 5px;"><?= $isChinese ? '[默认]' : '[PADRÃO]' ?></small>
                                    <?php endif; ?>
                                </span>
                                <?php if (($w['status'] ?? 'active') === 'active'): ?>
                                    <span
                                        style="color: #10b981; font-size: 10px; font-weight: 700; text-transform: uppercase; background: rgba(16,185,129,0.1); padding: 2px 6px; border-radius: 4px;"><?= $isChinese ? '活跃' : 'Ativa' ?></span>
                                <?php else: ?>
                                    <span
                                        style="color: #ef4444; font-size: 10px; font-weight: 700; text-transform: uppercase; background: rgba(239,68,68,0.1); padding: 2px 6px; border-radius: 4px; cursor: help;"
                                        title="<?= $isChinese ? '此钱包已被管理员禁用' : 'Esta carteira foi desativada pelo administrador' ?>">
                    ...
                    <?php else: ?>
                        <span
                            style="color: #cbd5e1; font-size: 12px;"><?= $isChinese ? '未注册' : 'Nenhuma carteira cadastrada' ?></span>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div style="border-top: 1px solid rgba(255,255,255,0.08); padding-top: 20px;">
                <h3
                    style="font-size: 13px; color: #64748b; text-transform: uppercase; letter-spacing: 0.05em; margin: 0 0 10px 0; border-bottom: 1px solid rgba(255,255,255,0.05); padding-bottom: 5px; display: flex; align-items: center; gap: 8px;">
                    <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                        stroke-linecap="round" stroke-linejoin="round">
                        <rect x="3" y="11" width="18" height="11" rx="2" ry="2" />
                        <path d="M7 11V7a5 5 0 0 1 10 0v4" />
                ...
                <!-- Status 2FA -->
                <div
                    style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 15px; background: rgba(255,255,255,0.02); padding: 12px; border-radius: 12px; border: 1px solid rgba(255,255,255,0.05);">
                    <span style="font-size: 13px; color: #cbd5e1;"><?= $isChinese ? '验证状态' : 'Status do 2FA' ?>:</span>
                    <span id="twofa-status-badge"
                        style="padding: 4px 10px; border-radius: 6px; font-weight: 700; font-size: 11px; text-transform: uppercase;">
                        Loading...
                    </span>
                </div>

                <!-- 2FA Setup Panel (Disabled -> Enable) -->
                <div id="twofa-setup-panel"
                    style="display: none; background: rgba(0,0,0,0.2); padding: 15px; border-radius: 16px; border: 1px solid rgba(255,255,255,0.03);">
                    ...
                    <div style="text-align: center; margin-bottom: 15px;">
                        <img id="twofa-qrcode" src="" alt="QR Code"
                            style="background: white; padding: 10px; border-radius: 12px; width: 140px; height: 140px; display: inline-block; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.3);">
                    </div>
                    ...
                    <div id="twofa-secret-box" onclick="copyTwoFaSecret()"
                        style="background: rgba(15,23,42,0.6); border: 1px solid #334155; padding: 10px; border-radius: 8px; font-family: monospace; font-size: 14px; color: #818cf8; text-align: center; font-weight: 700; letter-spacing: 0.1em; cursor: pointer; margin-bottom: 15px; transition: all 0.2s;"
                ...
                <div id="twofa-disable-panel"
                    style="display: none; background: rgba(239, 68, 68, 0.03); padding: 15px; border-radius: 16px; border: 1px solid rgba(239, 68, 68, 0.1);">
    ...
    <div id="wallet-deactivated-alert-modal"
        ...
        <div
            ...
            <div
                style="background: rgba(239, 68, 68, 0.1); width: 64px; height: 64px; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 20px auto; border: 1px solid rgba(239, 68, 68, 0.2);">
            ...
            <div
                style="background: rgba(239, 68, 68, 0.05); border: 1px solid rgba(239, 68, 68, 0.15); border-radius: 12px; padding: 12px; margin-bottom: 25px; display: flex; flex-direction: column; gap: 8px;">
                <?php foreach ($inactiveWalletAddresses as $addr): ?>
                    <div
                        style="font-family: monospace; font-size: 12px; color: #fca5a5; word-break: break-all; text-align: center; font-weight: 600;">
                        <?= esc($addr) ?>
                    </div>
                <?php endforeach; ?>
            </div>

            <button onclick="closeWalletDeactivatedModal()"
                style="width: 100%; background: #ef4444; border: none; padding: 14px; border-radius: 12px; color: white; font-weight: 700; font-size: 14px; cursor: pointer; transition: background 0.2s;">
    ...
    <div id="change-password-modal"
        ...
        <div
            ...
            <h1
                style="font-size: 20px; color: white; font-weight: 700; margin-bottom: 4px; padding-right: 40px; text-align: left;">
                <?= $isChinese ? '修改密码' : 'Alterar Senha' ?>
            </h1>
            ...
            <div id="pwd-alert"
                style="display: none; padding: 12px 15px; border-radius: 12px; font-size: 14px; margin-bottom: 20px; border: 1px solid; text-align: left;">
            </div>
            ...
            <form id="change-password-form" onsubmit="submitChangePassword(event)"
                ...
                <div style="display: flex; flex-direction: column; gap: 6px; text-align: left;">
                    <label
                        style="font-size: 12px; font-weight: 600; color: #94a3b8; text-transform: uppercase;"><?= $isChinese ? '当前密码' : 'Senha Atual' ?></label>
                ...
                <div style="display: flex; flex-direction: column; gap: 6px; text-align: left;">
                    <label
                        style="font-size: 12px; font-weight: 600; color: #94a3b8; text-transform: uppercase;"><?= $isChinese ? '新密码' : 'Nova Senha' ?></label>
                    <input type="password" id="pwd-new" placeholder="••••••••" required
                        style="width: 100%; background: rgba(15, 23, 42, 0.5); border: 1px solid #334155; padding: 12px; border-radius: 12px; color: white; outline: none; box-sizing: border-box; font-size: 15px;">
                </div>
                <div style="display: flex; flex-direction: column; gap: 6px; text-align: left;">
                    <label
                        style="font-size: 12px; font-weight: 600; color: #94a3b8; text-transform: uppercase;"><?= $isChinese ? '确认新密码' : 'Confirmar Nova Senha' ?></label>
                    <input type="password" id="pwd-confirm" placeholder="••••••••" required
                        style="width: 100%; background: rgba(15, 23, 42, 0.5); border: 1px solid #334155; padding: 12px; border-radius: 12px; color: white; outline: none; box-sizing: border-box; font-size: 15px;">
                </div>
                <button type="submit"
                    style="width: 100%; background: #3b82f6; color: white; border: none; padding: 14px; border-radius: 12px; font-weight: 600; font-size: 15px; cursor: pointer; transition: background-color 0.2s; margin-top: 10px;">
