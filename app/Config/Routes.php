...
$routes->group('admin', ['filter' => 'admin'], function ($routes) {
    ...
    $routes->post('suppliers/update/(:num)', 'SuppliersController::update/$1', ['as' => 'admin_suppliers_update']);
    $routes->post('suppliers/delete/(:num)', 'SuppliersController::delete/$1', ['as' => 'admin_suppliers_delete']);
    ...
    $routes->get('promotions', 'LotsController::promotions', ['as' => 'admin_promotions']);
    $routes->get('promotions/new', 'LotsController::createPromotion', ['as' => 'admin_promotions_create']);
    $routes->post('promotions/store', 'LotsController::storePromotion', ['as' => 'admin_promotions_store']);
    $routes->post('promotions/deactivate/(:num)', 'LotsController::deactivatePromotion/$1', ['as' => 'admin_promotions_deactivate']);
